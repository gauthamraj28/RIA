...
// query for investAdv ends....................................
 ...
 $getinfo="select 8 from address as a where a.firm_crd=$crd";
 $query1 = mysqli_query($conn, $getinfo);
 $rs= mysqli_fetch_assoc($query1);
 ...
 $getinfo="select * from registration as r where r.firm_crd=$crd";
 $query1 = mysqli_query($conn, $getinfo);
$rs= mysqli_fetch_assoc($query1);
...
$getinfo="select * from  states_filled_in as s where s.firm_crd=$crd";
 $query1 = mysqli_query($conn, $getinfo);
$rs= mysqli_fetch_assoc($query1);
...
while($rs= mysqli_fetch_assoc($query1)){
 ...
 $getinfo="select * from where_business as w where w.firm_crd=$crd";
 $query1 = mysqli_query($conn, $getinfo);
$rs= mysqli_fetch_assoc($query1);
